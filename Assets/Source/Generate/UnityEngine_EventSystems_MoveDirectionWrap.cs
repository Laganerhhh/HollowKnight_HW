...
public class UnityEngine_EventSystems_MoveDirectionWrap
{
	public static void Register(LuaState L)
	{
		...
		L.EndEnum();
		TypeTraits<UnityEngine.EventSystems.MoveDirection>.Check = CheckType;
		StackTraits<UnityEngine.EventSystems.MoveDirection>.Push = Push;
	}

	static void Push(IntPtr L, UnityEngine.EventSystems.MoveDirection arg)
	{
		ToLua.Push(L, arg);
	}
	...
	{
		return TypeChecker.CheckEnumType(typeof(UnityEngine.EventSystems.MoveDirection), L, pos);
	}
