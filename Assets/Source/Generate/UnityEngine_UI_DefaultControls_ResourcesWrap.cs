...
public class UnityEngine_UI_DefaultControls_ResourcesWrap
{
	...
	static int get_standard(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index standard on a nil value");
		}
	}
	...
	static int get_knob(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index knob on a nil value");
		}
	}
	...
	static int get_checkmark(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index checkmark on a nil value");
		}
	}
