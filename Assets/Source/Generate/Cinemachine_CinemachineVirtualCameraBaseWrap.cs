...
public class Cinemachine_CinemachineVirtualCameraBaseWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("CancelDamping", CancelDamping);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int CancelDamping(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			else if (count == 2)
			{
				...
				obj.CancelDamping(arg0);
				return 0;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: Cinemachine.CinemachineVirtualCameraBase.CancelDamping");
			}
		}
		catch (Exception e)
		{
	...
	static int set_m_StandbyUpdate(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Cinemachine.CinemachineVirtualCameraBase obj = (Cinemachine.CinemachineVirtualCameraBase)o;
			Cinemachine.CinemachineVirtualCameraBase.StandbyUpdateMode arg0 = (Cinemachine.CinemachineVirtualCameraBase.StandbyUpdateMode)ToLua.CheckObject(L, 2, typeof(Cinemachine.CinemachineVirtualCameraBase.StandbyUpdateMode));
