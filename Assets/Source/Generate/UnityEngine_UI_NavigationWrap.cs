...
public class UnityEngine_UI_NavigationWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("wrapAround", get_wrapAround, set_wrapAround);
	...
	static int Equals(IntPtr L)
	{
		try
		{
			...
			UnityEngine.UI.Navigation obj = (UnityEngine.UI.Navigation)ToLua.CheckObject(L, 1, typeof(UnityEngine.UI.Navigation));
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_wrapAround(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.UI.Navigation obj = (UnityEngine.UI.Navigation)o;
			bool ret = obj.wrapAround;
			LuaDLL.lua_pushboolean(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index wrapAround on a nil value");
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_wrapAround(IntPtr L)
	{
		object o = null;
