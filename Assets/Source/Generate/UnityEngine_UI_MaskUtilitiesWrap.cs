...
public class UnityEngine_UI_MaskUtilitiesWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("IsDescendantOrSelf", IsDescendantOrSelf);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int IsDescendantOrSelf(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			UnityEngine.Transform arg0 = (UnityEngine.Transform)ToLua.CheckObject<UnityEngine.Transform>(L, 1);
			UnityEngine.Transform arg1 = (UnityEngine.Transform)ToLua.CheckObject<UnityEngine.Transform>(L, 2);
			bool o = UnityEngine.UI.MaskUtilities.IsDescendantOrSelf(arg0, arg1);
	...
	static int GetRectMaskForClippable(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			UnityEngine.UI.IClippable arg0 = (UnityEngine.UI.IClippable)ToLua.CheckObject<UnityEngine.UI.IClippable>(L, 1);
	...
	static int GetRectMasksForClip(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 2);
			UnityEngine.UI.RectMask2D arg0 = (UnityEngine.UI.RectMask2D)ToLua.CheckObject<UnityEngine.UI.RectMask2D>(L, 1);
